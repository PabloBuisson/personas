...
export default function CreatePersonaCard({ key }: { key: string }) {
  return (
    <li className="text-base font-medium" key={key}>
      <article className="flex justify-center items-center h-full w-full bg-gray-300 border-[0.2em] border-gray-300 rounded-lg">
        <Link className="relative p-1 h-full" href={`/personas/new`}>
